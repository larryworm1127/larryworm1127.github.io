...
C/C++, \space CUDA, \space OpenMP, \space MPI, \space
Java, \space Android, \space Swing, \space
SQL, \space SQLite, \space PostgreSQL, \space MongoDB, \space
JavaScript, \space NodeJS, \space React, \space Express, \space
...
Linux, \space Git, \space Perforce, \space VirtualBox/VMWare, \space CI/CD, \space Heroku, \space Wireshark, \space Postman


\cvsection[]{Experience}

\cvevent{Software Engineer Intern}{Intel}{May 2021 -- Present}{Toronto, ON}

\divider

\cvevent{Software Engineer Intern}{Merchant Link}{May 2019 -- August 2019}{Ottawa, ON}
\begin{itemize}
...
\cvevent{\faGraduationCap \, B.Sc., Computer Science}{University of Toronto}{2018 -- 2023}{Toronto, ON}
