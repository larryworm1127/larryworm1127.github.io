...
\begin{itemize}
  \item Python, C, JavaScript, Java, Racket, Haskell, Shell/Bash, HTML, CSS, SQL
\end{itemize}
...
\begin{itemize}
  ...
  \item Android, NodeJS, Threading, Hypothesis, Pandas
  \item PostgreSQL, SQLite, MongoDB
  \item Unix, automated testing, CI/CD with CircleCI and Heroku, Git
